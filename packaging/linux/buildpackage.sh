#!/bin/bash
# Commit 25578 (119a5f1531a559e1024b435c6ef237ba601fcf74) is the last where its custom edited to build TS too
# In commit 25579 I checked out release-20181215's buildpackage.sh to fix Travis CI issues
